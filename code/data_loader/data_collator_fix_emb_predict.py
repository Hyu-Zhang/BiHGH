...
class SubgraphCollatorVocab:
    ...
    def __call__(self, batch):
        ...
        all_dgl_graph, all_node2re_id, all_re_id2node, all_nodes, all_triples, all_names = zip(*batch)
        # print(all_nodes)
        ...
        for b in range(batch_size):
            ...
            user, o_pos_list, o_neg_list = triple["user"], triple["pos"], triple["neg"]
            ...
            if len(tem_neg) < neg_len:
                tem_neg.extend([pad]*(neg_len - len(tem_neg)))
        ...
        return {
            ...
            "all_names": torch.tensor(all_names)
        }
